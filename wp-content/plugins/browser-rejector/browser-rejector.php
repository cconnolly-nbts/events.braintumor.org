					...
					<div id="jr_inner" style="min-width: 400px; width: auto; ">
						...
						<ul>
							<li id="jr_chrome" style="background-image: url(<?php echo plugins_url('/browsers/background_browser.gif', __FILE__); ?>); background-attachment: scroll; background-color: transparent; background-position: 0% 0%; background-repeat: no-repeat no-repeat; ">
								...
								<div><a href="http://www.google.com/chrome/"><?php _e('Chrome', 'browser-rejector') ?> </a></div>
							</li>
							<!--<li id="jr_gcf" style="background-image: url(<?php echo plugins_url('/browsers/background_browser.gif', __FILE__); ?>); background-attachment: scroll; background-color: transparent; background-position: 0% 0%; background-repeat: no-repeat no-repeat; ">
								<div class="jr_icon" style="background-image: url(<?php echo plugins_url('/browsers/browser_gcf.png', __FILE__); ?>); background-attachment: scroll; background-color: transparent; background-position: 0% 0%; background-repeat: no-repeat no-repeat; "></div>
								<div><a href="http://www.google.com/chromeframe/"><?php _e('Google Chrome Frame', 'browser-rejector') ?> <i><?php _e("(doesn't require admin)", 'browser-rejector') ?></i></a></div>
							</li>-->
							<li id="jr_msie" style="background-image: url(<?php echo plugins_url('/browsers/background_browser.gif', __FILE__); ?>); background-attachment: scroll; background-color: transparent; background-position: 0% 0%; background-repeat: no-repeat no-repeat; ">
								...
								<div><a href="http://www.microsoft.com/windows/Internet-explorer/"><?php _e('Internet Explorer', 'browser-rejector') ?> <b style="color: #f00; background-color: #fff;"></b></a></div>
							</li>
							<li id="jr_firefox" style="background-image: url(<?php echo plugins_url('/browsers/background_browser.gif', __FILE__); ?>); background-attachment: scroll; background-color: transparent; background-position: 0% 0%; background-repeat: no-repeat no-repeat; ">
								...
								<div><a href="http://www.mozilla.com/firefox/new"><?php _e('Firefox', 'browser-rejector') ?></a></div>
							</li>
							<li id="jr_opera" style="background-image: url(<?php echo plugins_url('/browsers/background_browser.gif', __FILE__); ?>); background-attachment: scroll; background-color: transparent; background-position: 0% 0%; background-repeat: no-repeat no-repeat; ">
								...
								<div><a href="http://www.opera.com/download/"><?php _e('Opera', 'browser-rejector') ?> </a></div>
							</li>
							<li id="jr_safari" style="background-image: url(<?php echo plugins_url('/browsers/background_browser.gif', __FILE__); ?>); background-attachment: scroll; background-color: transparent; background-position: 0% 0%; background-repeat: no-repeat no-repeat; ">
								...
								<div><a href="http://www.apple.com/safari/"><?php _e('Safari', 'browser-rejector') ?> </a></div>
							</li>
						</ul>
...
function brejectr_head() {
	...
	//automatically include the necessary tag to render chromeframe
	echo '<!--[if lt IE 9]><meta http-equiv="X-UA-Compatible" content="chrome=1" /><![endif]-->';
...
jQuery(document).ready(function($){
	$.reject({
		...
		display: ['chrome','msie','firefox','opera','safari'], //turns out ie9+ beats firefox in capabilities and overall features, so suggest it first; safari after Opera because of it's highly minimal OS support (latest OSX only)
		browserInfo: { // Settings for which browsers to display
			firefox: {
				text: '<?php _e('Firefox', 'browser-rejector') ?> ', // Text below the icon  
				url: 'http://www.mozilla.org/firefox/new' // URL For icon/text link  
			},
			safari: {
				text: '<?php _e('Safari', 'browser-rejector') ?>',  
				url: 'http://www.apple.com/safari/'
			},
			opera: {
				text: '<?php _e('Opera', 'browser-rejector') ?> ',  
				url: 'http://www.opera.com/download/'  
			},
			chrome: {
				text: '<?php _e('Chrome', 'browser-rejector') ?> ',  
				url: 'http://www.google.com/chrome/'
			},  
			msie: {
				text: '<?php _e('Internet Explorer', 'browser-rejector') ?>',  
